...
from definitions import MESI_STATES, MESI_ACTIONS, PROTOCOLS
...
class TestSuite(unittest.TestCase):
    ...
    def test_faster_than_mesi(self):
        ...
        computer = Computer(instructions, number_cores=2, protocol=PROTOCOLS.MESI)
        computer.start()

        self.assertEqual(computer.current_cycle, 431)
